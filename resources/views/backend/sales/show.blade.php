                ...
                <div class="col text-md-left text-center">
                    @if(json_decode($order->shipping_address))
                        <address>
                            ...
                            GSTIN : {{ json_decode($order->shipping_address)->gstin }}
                        </address>
                    @else
                        <address>
                            <strong class="text-main">
            ...
            <div class="clearfix float-right">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <tr>
                            <td>
                                <strong class="text-muted">{{ translate('COD Charges') }} :</strong>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                {{ single_price($order->total_shipping) }}
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <strong class="text-muted">{{ translate('Round Off') }} :</strong>
                            </td>
                            <td>
                                {{ single_price($order->round_off) }}
                            </td>
                        </tr>
                        <tr>
                            <td>
