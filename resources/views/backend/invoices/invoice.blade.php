	...
	<div>
		...
		<div style="background: #eceff4;padding: 1rem;">
			...
			<table>
				...
				<tr>
					<td class="gry-color small">{{  translate('GSTIN') }}: 19ADQPD7952H1Z2</td>
		...
		<div style="padding: 1rem;padding-bottom: 0">
            <table>
				...
				<tr><td class="gry-color small">{{ translate('GSTIN') }}: {{ $shipping_address->gstin }}</td></tr>
			</table>
		</div>
			            ...
			            <td>
					        <table class="text-right sm-padding small strong">
						        <tbody>
									...
									<tr>
										<th class="gry-color text-left">{{ translate('COD Charges') }}</th>
										<td class="currency">{{ single_price($order->cod_fee) }}</td>
									</tr>
									<tr>
										<th class="gry-color text-left">{{ translate('Shipping Cost') }}</th>
										<td class="currency">{{ single_price($order->total_shipping) }}</td>
									</tr>
									<tr >
									...
									<tr class="border-bottom">
										<th class="gry-color text-left">{{ translate('Round Off') }}</th>
										<td class="currency">{{ single_price($order->round_off) }}</td>
									</tr>
									<tr>
