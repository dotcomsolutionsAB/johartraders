                ...
                <div class="modal-body c-scrollbar-light">
                    <div class="p-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control mb-3 rounded-0" placeholder="{{ translate('Company Name')}}" name="company"></input>
                            </div>
                        </div>
                        <!-- Address -->
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control mb-3 rounded-0" placeholder="{{ translate('GSTIN')}}" name="gstin"></input>
                            </div>
                        </div>
                        <!-- Save button -->
