<form class="form-default" role="form" action="{{ route('addresses.update', $address_data->id) }}" method="POST">
    ...
    <div class="p-3">
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <input class="form-control mb-3 rounded-0" placeholder="{{ translate('Company Name')}}" name="company" value="{{ $address_data->company }}"></input>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control mb-3 rounded-0" placeholder="{{ translate('+91')}}" value="{{ $address_data->phone }}" name="phone" value="" required>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <input class="form-control mb-3 rounded-0" placeholder="{{ translate('GSTIN')}}" name="gstin" value="{{ $address_data->gstin }}"></input>
            </div>
        </div>
