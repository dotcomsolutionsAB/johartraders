<div class="card rounded-0 border shadow-none">
    ...
    <div class="card-body">
        ...
        <table class="table" style="margin-top: 2rem!important;">
            <tfoot>
                <!-- Subtotal -->
                <tr id="cod-fee" data-fee="{{ $cod_fee }}" data-total="{{ $subtotal }}" data-tax="{{ $tax }}" class="d-none">
                    <th class="pl-0 fs-14 pt-0 pb-2 text-dark fw-600 border-top-0">{{ translate('COD Fee') }}</th>
                    <td class="text-right pr-0 fs-14 pt-0 pb-2 fw-600 text-primary border-top-0">
                        <span class="fw-600">{{ single_price($cod_fee) }}</span>
                    </td>
                </tr>
                <!-- Total Shipping -->
                ...
                <tr class="cart-subtotal">
                    ...
                    <td class="text-right pr-0 fs-14 pt-0 pb-2 fw-600 text-primary border-top-0">
                        <span class="fw-600 sub_total">{{ single_price($subtotal) }}</span>
                    </td>
                </tr>
                <!-- Tax -->
                <tr class="cart-shipping">
                    ...
                    <td class="text-right pr-0 fs-14 pt-0 pb-2 fw-600 text-primary border-top-0">
                        <span class="fw-600 tax">{{ single_price($tax) }}</span>
                    </td>
                </tr>
                ...
                @php
                    ...
                    $round_off = $roundedTotal - $total;
                @endphp
                <tr class="cart-shipping">
                    <th class="pl-0 fs-14 pt-0 pb-2 text-dark fw-600 border-top-0">{{ translate('Round Off') }}</th>
                    <td class="text-right pr-0 fs-14 pt-0 pb-2 fw-600 text-primary border-top-0">
                        <span class="fw-600 round_off">{{ single_price($round_off) }}</span>
                    </td>
                </tr>
                <!-- Total -->
                <tr class="cart-total">
                    ...
                    <td class="text-right pr-0 fs-14 fw-600 text-primary">
                        <strong><span class="pay_total">{{ single_price($roundedTotal) }}</span></strong>
                    </td>
                </tr>
            </tfoot>
        </table>
