<div class="text-left">
    ...
    <div class="d-flex flex-wrap align-items-center">
        ...
        <!-- short Description -->
        <div class="col-md-9 tab-pane fade active show" id="tab_default_1">
            <div class="py-5">
        ...
        <form id="option-choice-form">
            ...
            @php
                ...
                if(isset($_REQUEST['id'])){
                    ...
                    //$product_stock = ProductStock::findOrFail($variation_id);

                    $variant = null;

                    foreach ($detailedProduct->stocks as $stock) {
                        //echo $stock.'<br/>';
                        if ($stock['sku'] == $variation_id) {
            ...
            @if ($detailedProduct->digital == 0)
                ...
                @if ($detailedProduct->choice_options != null)
                        ...
                        <div class="row no-gutters mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    <select class="form-control" name="attribute_id_{{ $choice->attribute_id }}">
                                        @foreach ($choice->values as $key => $value)
                    ...
                    @foreach (json_decode($detailedProduct->choice_options) as $key => $choice)
                        <div class="row no-gutters mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="aiz-radio-inline">
                                    @foreach ($choice->values as $valueKey => $value)
                                        @php
                                            $isChecked = (isset($variantValues[$key]) && $variantValues[$key] == $value) ? 'checked' : '';
                                        @endphp
                                        <label class="aiz-megabox pl-0 mr-2 mb-0">
                                            <input type="radio" name="attribute_id_{{ $choice->attribute_id }}"
                                                value="{{ $value }}"
                ...
                {{-- <div class="row no-gutters mb-3 qty-div">
                    <div class="col-sm-2">
    ...
    @else
        ...
        {{-- <div class="mt-3">
            @if ($detailedProduct->digital == 0)
                ...
                <button type="button" class="btn btn-secondary invalid fw-600 d-none" disabled>
                    <i class="la la-cart-arrow-down"></i> {{ translate('Selected Combinations Not Available') }}
                </button>
        ...
        @php
            $wa_message = empty($detailedProduct->wa_keyword) ? 'hi' : $detailedProduct->wa_keyword;
        @endphp

        <div class="container flex">
            <a aria-label="Chat on WhatsApp"  href="https://wa.me/+919123067443?text={{ $wa_message }}" class="wptwa-button wptwa-account wptwa-clearfix" data-number="919123067443" data-ga-label="Johar Traders" target="_blank">
                <i class="lab la-whatsapp ab" style="font-size: 5vh;"></i>
                ...
                <span class="wptwa-text">
                    <span class="wptwa-profile">JOHAR TRADERS &nbsp;/&nbsp; Huzefa Johar</span>
                    <span class="wptwa-copy">Need help? Chat via WhatsApp</span>
                </span>
            </a>
    
            {{-- <a aria-label="Send Email" href="mailto:johartraders@gmail.com?subject=Need%20Help&body=Hello%2C%20I%20need%20help%20with%20..." class="email" style="display: inline-flex;
                align-items: center;
                ...
                font-size: 14px;
                line-height: 1.5em" data-email="johartraders@gmail.com" data-ga-label="Johar Traders" target="_blank">
    
                <i class='lar la-envelope' style='font-size:36px'></i>
    
                <span class="wptwa-text">
                    <span class="wptwa-profile" style="font-family: sans-serif;
                    font-size: 14px;
                    line-height: 1.5em">JOHAR TRADERS &nbsp;/&nbsp; Huzefa Johar</span>
                    <br>
                    <span class="wptwa-copy">Need help? Send us an email</span>
                </span>
            </a> --}}
        </div>
