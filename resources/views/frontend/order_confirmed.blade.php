                                        ...
                                        <div class="col-xl-5 col-md-6 ml-auto mr-0">
                                            <table class="table ">
                                                <tbody>
                                                    ...
                                                    <!-- COD Fee -->
                                                    <tr>
                                                        <th class="border-top-0 py-2">{{ translate('COD Charges')}}</th>
                                                        <td class="text-right border-top-0 pr-0 py-2">
                                                            <span>{{ single_price($order->cod_fee) }}</span>
                                                        </td>
                                                    </tr>
                                                    <!-- Shipping -->
                                                    <tr>
                                                        ...
                                                        <td class="text-right border-top-0 pr-0 py-2">
                                                            <span>{{ single_price($order->total_shipping) }}</span>
                                                        </td>
                                                    </tr>
                                                    <!-- Tax -->
                                                    <tr>
                                                        ...
                                                        <td class="text-right border-top-0 pr-0 py-2">
                                                            <span>{{ single_price($order->tax) }}</span>
                                                        </td>
                                                    </tr>
                                                    <!-- Coupon Discount -->
                                                    <tr>
                                                    ...
                                                    <!-- Round Off -->
                                                    <tr>
                                                        <th class="border-top-0 py-2">{{ translate('Round Off')}}</th>
                                                        <td class="text-right border-top-0 pr-0 py-2">
                                                            <span>{{ single_price($order->round_off) }}</span>
                                                        </td>
                                                    </tr>
                                                    <!-- Total -->
                                                    <tr>
