                ...
                <div class="modal-body c-scrollbar-light">
                    <div class="p-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control mb-3 rounded-0" placeholder="{{ translate('Company Name')}}" name="company" required></input>
                            </div>
                        </div>
                        <!-- Address -->
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control mb-3 rounded-0" placeholder="{{ translate('+91')}}" name="phone" value="" required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control mb-3 rounded-0" placeholder="{{ translate('GSTIN')}}" name="gstin" required></input>
                            </div>
                        </div>
                        <!-- Save button -->
