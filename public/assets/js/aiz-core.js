...
(function ($) {
    ...
    AIZ.extra = {
        ...
        clickCategoryMenu: function () {
            ...
            menu.hide(); // Initially hide the menu
            menu.removeClass("d-none");
        
            // Show menu on mouse enter (hover) over the category menu bar
            $("#category-menu-bar").on("mouseenter", function () {
                menu.stop(true, true).slideDown(500); // Show the menu with a slide-down animation
                $("#category-menu-bar-icon").addClass("show"); // Add icon class to indicate menu is open
            });
        
            // Keep the menu open while hovering over the menu itself
            menu.on("mouseenter", function () {
                menu.stop(true, true).show(); // Ensure the menu remains open if hovering on the menu
            });
        
            // Close menu when mouse leaves both the menu and the menu bar
            $("#category-menu-bar, #click-category-menu").on("mouseleave", function () {
                menu.stop(true, true).slideUp(500); // Hide the menu with a slide-up animation
                $("#category-menu-bar-icon").removeClass("show"); // Remove icon class when menu is closed
            });
        },
